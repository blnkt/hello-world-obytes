...
- [x] 4.4 Add currency validation in tile interactions
- [x] 4.5 Prevent game start with insufficient currency
...
- [x] 5.4 Update level display and progression tracking
- [x] 5.5 Review and fix game modal UI and progression flow
...
- [x] 6.5 Test level progression
- [x] 6.6 Ensure all existing tests still pass
