...
describe('ShortcutVisualization (Task 1.7)', () => {
  ...
  it('should render shortcut visualization', () => {
    ...
    const { getByTestId } = render(
      <ShortcutVisualization shortcuts={shortcuts} />
    );
  ...
  it('should show energy reduction for each shortcut', () => {
    const shortcuts = [createMockShortcut('shortcut-1', 2, 1, 5)];
  ...
  it('should indicate permanent shortcuts', () => {
    const permanentShortcut: Shortcut = createMockShortcut(
      'shortcut-1',
      2,
      1,
      5
    ...
    const { getByText } = render(
      <ShortcutVisualization shortcuts={[permanentShortcut]} />
    );
  ...
  it('should show shortcut depth range', () => {
    const shortcuts = [createMockShortcut('shortcut-1', 3, 1, 15)];
