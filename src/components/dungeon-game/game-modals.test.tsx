...
describe('WinModal', () => {
  ...
  it('should display congratulations message', () => {
    ...
    expect(screen.getByText('Congratulations! You found the exit and completed this level.')).toBeTruthy();
...
describe('GameOverModal', () => {
  ...
  it('should handle different turn counts correctly', () => {
    const { rerender } = render(<GameOverModal {...defaultProps} turnsUsed={0} />);
