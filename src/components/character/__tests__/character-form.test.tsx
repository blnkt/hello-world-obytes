...
describe('CharacterForm', () => {
  ...
  it('renders the form with header and name field', () => {
    render(<CharacterForm name="Test Character" setName={mockSetName} />);

    expect(screen.getByText('Create Your Character')).toBeTruthy();
    expect(
      screen.getByText('Choose your name to begin your adventure')
    ).toBeTruthy();
  ...
  it('calls setName when name field is interacted with', () => {
    render(<CharacterForm name="" setName={mockSetName} />);
