...
describe('Component Color Imports', () => {
  ...
  const commonHardcodedColors = [
    ...
    '#f2f2f2', '#3f3d56', '#7eb55a', '#e6e6e6',
    '#FC6276', '#192332', '#CCCFD6', '#D96B5E',
    '#C55A4D', '#7A6F66', '#6B5F57', '#F7D17B',
    '#E6C269', '#8C7099', '#7D618A', '#5EC0C0',
    '#4DAFAF', '#E0D9CE', '#D1CABF', '#9CA3AF',
    '#F3F4F6', '#DC2626', '#3B82F6', '#8B5CF6',
    '#10B981', '#6B7280', '#F5F0E8', '#4CAF50',
    '#2196F3', '#666', '#888',
  ];
