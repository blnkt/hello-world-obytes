...
export const NoData = () => (
  <Svg width={200} height={200} viewBox="0 0 647.636 632.174">
    ...
    />
    <Circle cx={190.154} cy={24.955} r={20} fill={colors.success[500]} />
    <Circle cx={190.154} cy={24.955} r={12.665} fill={colors.white} />
    <Path
    ...
    <Path
      ...
      fill={colors.success[500]}
    />
    <Circle cx={433.636} cy={105.174} r={20} fill={colors.success[500]} />
    <Circle cx={433.636} cy={105.174} r={12.182} fill={colors.white} />
  </Svg>
);
